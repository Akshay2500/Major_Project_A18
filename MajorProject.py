...
def singleScaleRetinex(img, sigma):
    ...
    cv2.imwrite('ssr.jpg',retinex)

    cv2.imshow('ssr',retinex)
...
def multiScaleRetinex(img, sigma_list):
    ...
    cv2.imwrite('msr.jpg',retinex)

    cv2.imshow('msr',retinex)
...
def colorRestoration(img, alpha, beta):
    ...
    cv2.imwrite('cr.jpg',color_restoration)

    cv2.imshow('cr',color_restoration)
...
cv2.imwrite('amsrcr.jpg',img_amsrcr)
